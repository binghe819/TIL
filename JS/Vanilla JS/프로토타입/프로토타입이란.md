...
- [2 JS의 프로토타입](#2-js의-프로토타입)
  ...
  - [2-3 Array 객체 예시](#2-3-array-객체-예시)
  - [2-4 프로토타입 예시](#2-4-프로토타입-예시)
- [3 프로토타입 사용 이유 - 일반화](#3-프로토타입-사용-이유---일반화)
- [참고](#참고)
...
즉, **프로토타입 기반 언어는 객체지향 프로그래밍을 구현하기 위해 원형 객체를 복제하여 새로운 객체를 생성하는 언어를 의미한다.**
...
`프로토타입 언어는 원형 객체를 복제하여 새로운 객체를 생성하는 언어`로 이해할 수 있다.
...
<p align="center"><img src="./image/image-3413451531431.png"> </p>

<p align="center"><img src="./image/js_prototype_example.png"><br>출처: 인사이드 자바스크립트 </p>
...
<p align="center"><img src="./image/test7.png"><br>출처: 인사이드 자바스크립트 </p>
1. 인스턴스 생성과 this 바인딩
...
<p align="center"><img src="./image/array_prototype_three.png"><br>출처: https://stackoverflow.com/questions/41208613/when-to-use-array-prototype-and-when-to-use-this-in-javascript </p>
...
<p align="center"><img src="./image/array_prototype_example.png"> </p>
...
> **프로토타입을 이용하여 인스턴스의 메서드를 일반화시킨 것!**
